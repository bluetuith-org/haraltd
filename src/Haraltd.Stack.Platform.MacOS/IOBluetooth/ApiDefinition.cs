...
namespace IOBluetooth
{
    ...
    // @protocol IOBluetoothDeviceAsyncCallbacks <NSObject>
    [Protocol, Model]
    [BaseType(typeof(NSObject))]
    interface BluetoothDeviceAsyncCallbacks
    {
    ...
    public partial interface BluetoothDevice : INSCoding, INSSecureCoding
    {
        ...
        int OpenL2CAPChannelSync(
            out L2CapChannel newChannel,
            L2CapPsm psm,
            NSObject channelDelegate
        );

        // -(IOReturn)openL2CAPƒChannelAsync:(IOBluetoothL2CAPChannel **)newChannel withPSM:(BluetoothL2CAPPSM)psm delegate:(id)channelDelegate;
        [Export("openL2CAPChannelAsync:withPSM:delegate:")]
        int OpenL2CAPChannelAsync(
            out L2CapChannel newChannel,
            L2CapPsm psm,
            NSObject channelDelegate
        );
        ...
        int OpenRfcommChannelSync(
            out RfcommChannel rfcommChannel,
            byte channelID,
            NSObject channelDelegate
        );
    ...
    interface DeviceInquiry
    {
        ...
        void SetSearchCriteria(
            ...
            DeviceClassMajor majorDeviceClass,
            DeviceClassMinor minorDeviceClass
        );
    }
    ...
    interface DeviceInquiryDelegate
    {
        ...
        [
            ...
            EventArgs("UpdatingDeviceNamesStarted")
        ]
        ...
        [
            ...
            EventName("Completed"),
            EventArgs("DeviceInquiryCompleted")
        ]
    ...
    interface DevicePair
    {
        ...
        // -(instancetype)initWithDelegate:(id)delegate;
        [Export("initWithDelegate:")]
        IntPtr Constructor(DevicePairDelegate @delegate);
        ...
        unsafe void ReplyPinCode(nuint pinCodeSize, ref BluetoothPinCode pinCode);
    ...
    interface DevicePairDelegate
    {
        ...
        [
            ...
            EventArgs("PairingUserConfirmationRequest")
        ]
        ...
        [
            ...
            EventArgs("PairingUserPasskeyNotification")
        ]
        ...
        void PairingFinished(DevicePair sender, int error);
        ...
        [
            ...
            EventName("Completed"),
            EventArgs("SimplePairingCompleted")
        ]
    ...
    interface HostControllerDelegate
    {
        ...
        [
            ...
            EventName("ReadRssiForDeviceCompleted"),
            EventArgs("RssiForDevice")
        ]
        unsafe void ReadRssiForDeviceComplete(
            NSObject controller,
        ...
        [
            ...
            EventArgs("LinkQualityForDevice")
        ]
        unsafe void ReadLinkQualityForDeviceComplete(
            NSObject controller,
            BluetoothDevice device,
            HciLinkQualityInfo info,
            int error
        );
    }
    ...
    public interface L2CapChannel : INSPortDelegate
    {
        ...
        UserNotification RegisterForChannelOpenNotifications(
            NSObject @object,
            Selector selector,
            ushort psm,
            uint direction
        ...
        int SetDelegateWithConfiguration(
            L2CapChannelDelegate channelDelegate,
            NSDictionary channelConfiguration
        );
    ...
    public interface L2CapChannelDelegate
    {
        ...
        [
            ...
            EventArgs("L2CapChannelOpenCompleted")
        ]
        ...
        [
            ...
            EventName("WriteCompleted"),
            EventArgs("L2CapChannelWriteCompleted")
        ]
    ...
    public partial interface RfcommChannel : INSPortDelegate
    {
        [Wrap("WeakDelegate")]
        ...
        UserNotification RegisterForChannelOpenNotifications(
            ...
            Selector selector,
            byte channelID,
            UserNotificationChannelDirection direction
        );
        ...
        // -(IOReturn)writeAsync:(void *)data length:(UInt16)length refcon:(void *)refcon;
        [Export("writeAsync:length:refcon:")]
        unsafe int WriteAsync(byte* data, ushort length, IntPtr refcon);

        // -(IOReturn)writeSync:(void *)data length:(UInt16)length;
        [Export("writeSync:length:")]
        unsafe int WriteSync(byte* data, ushort length);
    ...
    public interface RfcommChannelDelegate
    {
        ...
        [
            ...
            EventName("OpenCompleted"),
            EventArgs("RfcommChannelOpenCompleted")
        ]
        ...
        [
            ...
            EventName("WriteCompleted"),
            EventArgs("RfcommChannelWriteCompleted")
        ]
    ...
    public interface SdpDataElement : INSCoding, INSSecureCoding
    {
        ...
        SdpDataElement WithType(
            SdpDataElementType type,
            byte sizeDescriptor,
            uint size,
            NSObject value
        );
    ...
    public interface SdpServiceRecord : INSCoding, INSSecureCoding
    {
        ...
        unsafe SdpServiceRecord WithSDPServiceRecordRef(IntPtr sdpServiceRecordRef);

        // -(IOBluetoothSDPServiceRecordRef)getSDPServiceRecordRef;
        [Export("getSDPServiceRecordRef")]
        unsafe IntPtr SdpServiceRecordRef { get; }
    ...
    public unsafe interface SdpUuid
    {
        ...
        [Static]
        [Export("uuid16:")]
        SdpUuid FromUuid16(SdpUuid16 uuid16);
    ...
    interface ObexSession
    {
        ...
        int ObexConnect(
            byte flags,
            ushort maxPacketLength,
            IntPtr optionalHeaders,
            nuint optionalHeadersLength,
            Selector selector,
            NSObject target,
            IntPtr userRefCon
        );
        ...
        int ObexPut(
            byte isFinalChunk,
            IntPtr headersData,
            nuint headersDataLength,
            IntPtr bodyData,
            nuint bodyDataLength,
            Selector selector,
            NSObject target,
            IntPtr userRefCon
        );
        ...
        void SetEventSelector(
            Selector eventSelector,
            NSObject eventSelectorTarget,
            NSObject userRefCon
        );
    ...
    public interface BluetoothObexSession : RfcommChannelDelegate
    {
        ...
        BluetoothObexSession WithIncomingRFCOMMChannel(
        ...
        void SetOpenTransportConnectionAsyncSelector(
            Selector selector,
            NSObject selectorTarget,
            NSObject userRefCon
        );
    ...
    interface ObexFileTransferServicesDelegate
    {
        ...
        [
            ...
            EventName("ConnectionCompleted"),
            EventArgs("FileTransferServices")
        ]
        ...
        [
            ...
            EventName("DisconnectionCompleted"),
            EventArgs("FileTransferServices")
        ]
        void FileTransferServicesDisconnectionComplete(
            ObexFileTransferServices services,
            int error
        );
        ...
        [
            ...
            EventName("RemoveItemCompleted"),
            EventArgs("FileTransferServicesItem")
        ]
        void FileTransferServicesRemoveItemComplete(
            ObexFileTransferServices services,
            int error,
            string itemName
        );
        ...
        [
            ...
            EventName("CreateFolderCompleted"),
            EventArgs("FileTransferServicesFolder")
        ]
        void FileTransferServicesCreateFolderComplete(
            ObexFileTransferServices services,
            int error,
            string folderName
        );
        ...
        [
            ...
            EventName("PathChangeCompleted"),
            EventArgs("FileTransferServicesPath")
        ]
        void FileTransferServicesPathChangeComplete(
            ObexFileTransferServices services,
            int error,
            string path
        );
        ...
        [
            ...
            EventName("RetrieveFolderListingCompleted"),
            EventArgs("FolderListing")
        ]
        void FileTransferServicesRetrieveFolderListingComplete(
            ObexFileTransferServices services,
            int error,
            NSString[] listing
        );
        ...
        [
            ...
            EventName("FilePreparationCompleted"),
            EventArgs("FileTransferServices")
        ]
        void FileTransferServicesFilePreparationComplete(
            ObexFileTransferServices services,
            int error
        );
        ...
        [
            ...
            EventName("SendFileProgress"),
            EventArgs("FileTransferServicesProgress")
        ]
        void FileTransferServicesSendFileProgress(
            ObexFileTransferServices services,
            NSDictionary progressDescription
        );
        ...
        [
            ...
            EventName("CopyRemoteFileProgress"),
            EventArgs("FileTransferServicesProgress")
        ]
        void FileTransferServicesCopyRemoteFileProgress(
            ObexFileTransferServices services,
            NSDictionary progressDescription
        );
        ...
        [
            ...
            EventName("CopyRemoteFileCompleted"),
            EventArgs("FileTransferServices")
        ]
        void FileTransferServicesCopyRemoteFileComplete(
            ObexFileTransferServices services,
            int error
        );
    }
